export const cycleStages = [
  ...
  },
  {
    ...
    body: "Wspólny przegląd dziennika poprawek z całego miesiąca i szczera rozmowa o tym, co realnie się zmieniło. Na tej podstawie zapada decyzja, czy kolejny cykl idzie w tę samą stronę, czy zmienia kierunek.",
  },
] as const;
