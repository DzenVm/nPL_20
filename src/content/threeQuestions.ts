export const threeQuestions = [
  {
    question: "Kto naprawdę prowadzi zajęcia i da się to zweryfikować?",
    answer:
      "Każdy prowadzący ma wykształcenie filologiczne lub certyfikat metodyczny (CELTA, TESOL lub odpowiednik) i przechodzi ocenianą sesję próbną, zanim trafi na listę. Szczegóły standardu opisujemy wprost, nie tylko deklaratywnie, w sekcji o prowadzących.",
  },
  {
