        ...
        <div className="wrap wrap--mid">
          ...
          <div className="prose mt-2">
            <p>
              ...
              pamięci, odpowiedź na nieoczekiwane pytanie, drobna dygresja), żeby zobaczyć, gdzie i jak
              pojawia się blokada, nie tylko czy się pojawia.
            </p>
            <p>
        ...
        <div className="wrap wrap--mid">
          ...
          <div className="prose mt-2">
            ...
            <p>
              ...
              listę oczekujących z konkretnym, przewidywanym terminem startu — nie na czas nieokreślony.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="wrap wrap--mid">
          ...
          <div className="prose mt-2">
            <p>
              ...
              wszystkich potknięć — tylko to, co się powtórzyło, więc realnie warto to przećwiczyć osobno.
            ...
            <ul>
              ...
              <li>
                do przećwiczenia w tym tygodniu: „depend on”, nie „depend from” — pojawiło się dwukrotnie
              </li>
            </ul>
            <p>
